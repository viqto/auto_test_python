...
try:
    ...
    input1 = browser.find_element_by_css_selector("div.first_block>div>input")
    ...
    input3 = browser.find_element_by_css_selector("div.second_block>div>input")
    input3.send_keys("+79123456789")
    input3 = browser.find_element_by_css_selector("div.second_block>div.second_class>input")
